...
if(isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $inv_menu = $conn->real_escape_string($_POST['inv_menu']);
        ...
        $sql = "UPDATE tblinventario SET inv_menu='$inv_menu', reg_entrada='$reg_entrada', reg_salida='$reg_salida', Descripcion='$Descripcion', Novedades='$Novedades', Cantidad='$Cantidad' WHERE id_inventario='$Id_inventario'";
